...
from data_structure_2 import data
...
class CropPlantingEnv(gym.Env):
    ...
    def __init__(self):
        ...
        print("aattt")
        print(self.data.sale_matrix.shape)
        print(self.data.sale_2023.shape)
        ...
        print(self.sale_matrix.shape)
        print(self.sale_matrix_2023.shape)
        self.input_dim = 1082
        # obs: (82,41,8)
