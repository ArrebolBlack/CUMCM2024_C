...
if __name__ == "__main__":
    ...
    model_path = '/home/ziwu/Newpython/C_2024/algo/Q1_2/DuelingDQN/DuelingDQN_attention/checkpoints/best_ddqn_attn_model_1_2.pth'
    ...
    # 保存最优动作为 .npy 文件
    save_action_dir = '/home/ziwu/Newpython/C_2024/algo/Q1_2/DuelingDQN/DuelingDQN_attention/result'
    save_action_path = os.path.join(save_action_dir, 'best_action_ddqn_attn_1_2.npy')
