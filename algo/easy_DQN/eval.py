...
from dueling_train import DuelingCropQNetwork#假设你用的是 DuelingCropQNetwork


import torch
import numpy as np
from env import CropPlantingEnv
from dueling_train import DuelingCropQNetwork
...
if __name__ == "__main__":
    ...
    model_path = '/home/shengjiaao/Newpython/C_2024/best_dqn_model.pth'
    ...
    # 保存最优动作为 .npy 文件
    save_action_dir = '/home/shengjiaao/Newpython/C_2024/algo/easy_DQN/result'
    save_action_path = os.path.join(save_action_dir, 'best_action_ddqn.npy')
