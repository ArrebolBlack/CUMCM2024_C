...
if __name__ == "__main__":
    ...
    model_path = '/home/shengjiaao/Newpython/C_2024/algo/DuelingDQN/DuelingDQN_attention/checkpoints/best_ddqn_attn_model.pth'
    ...
    # 保存最优动作为 .npy 文件
    save_action_dir = '/home/shengjiaao/Newpython/C_2024/algo/DuelingDQN/DuelingDQN_attention/result'
    save_action_path = os.path.join(save_action_dir, 'best_action_ddqn_attn_1_1.npy')
