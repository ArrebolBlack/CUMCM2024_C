...
def compute_reward(action):
    # return objective_function(action, env.yield_matrix, env.price_matrix, env.cost_matrix, env.sale_matrix,
    #                           env.plot_areas)
...
analyze_objective_distribution(action_space_shape=(82, 41, 7), num_samples=1000, batch_size=100)
import gc
gc.collect()  # 手动释放内存
